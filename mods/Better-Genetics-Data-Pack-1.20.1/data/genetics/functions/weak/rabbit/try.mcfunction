...
execute unless entity @s[nbt={HandItems:[{},{tag:{Aging:5,Fertility:4,Hide:4,Meat:4,Feet:4}}]}] run clear @p[tag=genetics.caster,gamemode=!creative] minecraft:firework_star{display:{Name:'{"text":"Weak Mutation Catalyst","color":"aqua","italic":false}'}} 1
execute unless entity @s[nbt={HandItems:[{},{tag:{Aging:5,Fertility:4,Hide:4,Meat:4,Feet:4}}]}] run function genetics:weak/rabbit/random
