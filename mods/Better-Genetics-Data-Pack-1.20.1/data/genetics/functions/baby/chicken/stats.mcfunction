...
scoreboard players set stat3 genetics.var 1
scoreboard players set special genetics.var 0
execute as @e[tag=genetics.parent1,limit=1] run function genetics:baby/chicken/get1
execute as @e[tag=genetics.parent2,limit=1] run function genetics:baby/chicken/get2
function genetics:baby/stats/aging_fertility
function genetics:baby/stats/stat3_4
execute store result entity @s HandItems[1].tag.Egg int 1 run scoreboard players get stat3 genetics.var
