...
execute as @e[tag=genetics.parent1,limit=1] run function genetics:baby/horse/get1
execute as @e[tag=genetics.parent2,limit=1] run function genetics:baby/horse/get2
...
execute if score friendly genetics.var matches 1 run function genetics:baby/horse/attributes_1
#execute if score horse genetics.set matches 1 run function genetics:baby/horse/attributes_2
