...
execute store result score stat2 genetics.var run data get entity @s HandItems[1].tag.Armour 1
execute store result score stat3 genetics.var run data get entity @s HandItems[1].tag.Speed 1
