...
execute as @e[tag=genetics.parent1,limit=1] run function genetics:baby/strider/get1
execute as @e[tag=genetics.parent2,limit=1] run function genetics:baby/strider/get2
function genetics:baby/stats/aging_fertility
execute if score horse genetics.set matches 2 run function genetics:baby/strider/attributes_1
execute if score horse genetics.set matches 1 run function genetics:baby/strider/attributes_2
