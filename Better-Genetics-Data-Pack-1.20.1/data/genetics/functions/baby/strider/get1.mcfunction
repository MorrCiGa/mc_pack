...
execute store result score stat1 genetics.var run data get entity @s HandItems[1].tag.Speed 1
execute store result score stat2 genetics.var run data get entity @s HandItems[1].tag.String 1
