...
execute if score random1 genetics.var matches 0 store result score stat2 genetics.var run data get entity @s HandItems[1].tag.Items 1
execute if score random2 genetics.var matches 0 store result score stat3 genetics.var run data get entity @s HandItems[1].tag.Effect 1
