...
execute as @e[tag=genetics.parent1,limit=1] run function genetics:baby/pig/get1
execute as @e[tag=genetics.parent2,limit=1] run function genetics:baby/pig/get2
function genetics:baby/stats/aging_fertility
function genetics:baby/stats/stat1_5
execute store result entity @s HandItems[1].tag.Pork int 1 run scoreboard players get stat1 genetics.var
