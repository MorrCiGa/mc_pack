...
execute as @e[tag=genetics.parent1,limit=1] run function genetics:baby/rabbit/get1
execute as @e[tag=genetics.parent2,limit=1] run function genetics:baby/rabbit/get2
