...
execute store result score stat1 genetics.var run data get entity @s HandItems[1].tag.Attack 1
execute store result score stat2 genetics.var run data get entity @s HandItems[1].tag.Aggression 1
execute if score random1 genetics.var matches 0 store result score stat3 genetics.var run data get entity @s HandItems[1].tag.Horn 1
