...
execute as @e[tag=genetics.parent1,limit=1] run function genetics:baby/sheep/get1
execute as @e[tag=genetics.parent2,limit=1] run function genetics:baby/sheep/get2
...
execute if score stat2 genetics.var matches 1 run tag @s add genetics.regrow
execute store result entity @s HandItems[1].tag.Grass byte 1 run scoreboard players get stat2 genetics.var
