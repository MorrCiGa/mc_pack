...
execute if score temp genetics.var matches 1..5 store result entity @s HandItems[1].tag.Mutton int 1 run scoreboard players get temp genetics.var
...
execute if score temp genetics.var matches 6.. run function genetics:weak/sheep/random